...
meta_df<-meta_df[meta_df$N_CCAA=='CCAA Com. Valenciana',]
```
...
ds3 <- read_delim("data/2019/Datos_diarios/C6H6_DD_2019.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE,  show_col_types = FALSE)
...
library(dplyr)
library(tidyr)
z_2019<-merge(meta_df,z, by=c('PROVINCIA','MUNICIPIO','ESTACION'))
columnas<-c(colnames(z),'LATITUD_G','LONGITUD_G','ZONA')
