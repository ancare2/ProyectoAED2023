...
packages = c("tidyverse","knitr",'GGally','ggplot2','sf','readr','readxl','dplyr','tidyr','kableExtra','VIM','car','ggformula','ggpubr')
...
Observandose en la siguiente gráfica que el ICA predominante es razonablemente bueno.
